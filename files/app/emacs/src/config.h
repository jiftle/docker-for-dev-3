...
#define EMACS_CONFIG_FEATURES "XPM JPEG TIFF GIF PNG SOUND DBUS GSETTINGS GLIB NOTIFY LIBSELINUX GNUTLS LIBXML2 FREETYPE XFT ZLIB TOOLKIT_SCROLL_BARS GTK3 X11 XDBE XIM THREADS"

/* Define to the options passed to configure. */
#define EMACS_CONFIG_OPTIONS "--with-mailutils --with-pop"
...
#define PACKAGE_STRING "GNU Emacs 26.3"
